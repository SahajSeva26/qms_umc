...
*Last updated: 2026-08-05 (backend `fixes/division`: tenant admin role code flattened to plain `admin` + RoleService.create dup-check scoped to {tenant, code}; e2e-verified, uncommitted — see session log + memory `role-code-conventions`).*
*Update this file at the end of every session.*
