...
const get = async (req: any, res: any) => {
    try {
        ...
        return ResponseHandler.appResponse(res, StatusCodes.OK, true, 'Role type fetched successfully', RoleTypeMapper.toResponse(roleType));
    } catch (error: any) {
...
const search = async (req: any, res: any) => {
    try {
        ...
        const result = await RoleTypeService.search(query, ctx, { pagination });

        return ResponseHandler.appResponse(res, StatusCodes.OK, true, 'Role types fetched successfully', RoleTypeMapper.toSearchResponse(result));
    } catch (error: any) {
        return ResponseHandler.appResponse(res, error?.statusCode, false, error?.message, null);
    }
};
...
const create = async (req: any, res: any) => {
    try {
        ...
        return ResponseHandler.appResponse(res, StatusCodes.CREATED, true, 'Role type created successfully', RoleTypeMapper.toResponse(roleType));
    } catch (error: any) {
        return ResponseHandler.appResponse(res, error?.statusCode, false, error?.message, null);
    }
};
...
const update = async (req: any, res: any) => {
    try {
        ...
        return ResponseHandler.appResponse(res, StatusCodes.OK, true, 'Role type updated successfully', RoleTypeMapper.toResponse(roleType));
    } catch (error: any) {
        return ResponseHandler.appResponse(res, error?.statusCode, false, error?.message, null);
    }
};
