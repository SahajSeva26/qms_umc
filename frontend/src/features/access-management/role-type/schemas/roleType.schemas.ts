import { z } from 'zod'
import { ROLE_TYPE_CODES } from '@/features/access-management/role-type/constants/roleTypeCodes'

// Validation schemas for the role-type create/update forms. Follows the
// exact pattern of `@/features/access-management/tenant/schemas/tenant.schemas.ts` /
