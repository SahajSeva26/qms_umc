...
import { usePermissionGroup } from '@/features/pbac/permission-group/hooks/usePermissionGroup'
import { useUpdatePermissionGroup } from '@/features/pbac/permission-group/hooks/useUpdatePermissionGroup'
import { PERMISSION_GROUP_ROUTES } from '@/features/pbac/permission-group/permission-group.routes'
import { PERMISSION_CATALOG } from '@/features/pbac/permission-group/constants/permissionCatalog'
import PermissionGroupStatusPill from '@/features/pbac/permission-group/components/PermissionGroupStatusPill'
import { Button } from '@/components/ui/button'
import { updatePermissionGroupSchema } from '@/features/pbac/permission-group/schemas/permissionGroup.schemas'
...
// (IPermission[], not bare codes — see pbac.types.ts).
