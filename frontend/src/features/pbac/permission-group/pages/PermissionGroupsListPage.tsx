...
import { usePermissionGroups } from '@/features/pbac/permission-group/hooks/usePermissionGroups'
import PermissionGroupsTable from '@/features/pbac/permission-group/components/PermissionGroupsTable'
