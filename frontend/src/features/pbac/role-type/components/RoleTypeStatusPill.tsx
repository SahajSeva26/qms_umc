import type { RoleTypeStatus } from '@/types/pbac.types'

// Mirrors `@/features/pbac/permission-group/components/PermissionGroupStatusPill.tsx`
...
// RoleTypeEntity['status'] TODO in pbac.types.ts), so this renders a neutral
