...
import { useRoleType } from '@/features/pbac/role-type/hooks/useRoleType'
import { useUpdateRoleType } from '@/features/pbac/role-type/hooks/useUpdateRoleType'
import { useCreateRoleType } from '@/features/pbac/role-type/hooks/useCreateRoleType'
import { useTenantPermissionGroup } from '@/features/pbac/role-type/hooks/useTenantPermissionGroup'
...
import { ROLE_TYPE_CODE_GROUPS, isReservedTenantAdminCode } from '@/features/pbac/role-type/constants/roleTypeCodes'
...
import { createRoleTypeSchema, updateRoleTypeSchema } from '@/features/pbac/role-type/schemas/roleType.schemas'
import type { RoleTypeCode, RoleTypeStatus } from '@/types/pbac.types'
...
// Mirrors `@/features/pbac/permission-group/pages/PermissionGroupDetailPage.tsx`'s
...
const RoleTypeDetailPage = () => {
  ...
  useEffect(() => {
    if (roleType && !isCreateMode) {
      ...
      // comment in pbac.types.ts) — no .code projection needed.
