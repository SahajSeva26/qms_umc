import type { RoleStatus } from '@/types/pbac.types'

// Mirrors `@/features/pbac/role-type/components/RoleTypeStatusPill.tsx`
...
// in pbac.types.ts, but this still tolerates an undefined value defensively.
