...
import { useRole } from '@/features/pbac/role/hooks/useRole'
import { useUpdateRole } from '@/features/pbac/role/hooks/useUpdateRole'
import { useCreateRole } from '@/features/pbac/role/hooks/useCreateRole'
import { useTenantPermissionGroup } from '@/features/pbac/role-type/hooks/useTenantPermissionGroup'
import { useRoleTypes } from '@/features/pbac/role-type/hooks/useRoleTypes'
...
import { createRoleSchema, updateRoleSchema } from '@/features/pbac/role/schemas/role.schemas'
import type { RolePopulatedRoleType, RolePopulatedUser, RoleStatus } from '@/types/pbac.types'
...
//
// Mirrors `@/features/pbac/role-type/pages/RoleTypeDetailPage.tsx`'s overall
