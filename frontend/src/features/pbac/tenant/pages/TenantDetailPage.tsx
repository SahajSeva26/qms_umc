...
import { useTenant } from '@/features/pbac/tenant/hooks/useTenant'
import { useUpdateTenant } from '@/features/pbac/tenant/hooks/useUpdateTenant'
...
import { updateTenantSchema } from '@/features/pbac/tenant/schemas/tenant.schemas'
import type { TenantStatus, TenantType } from '@/types/pbac.types'
...
//
// Field gating (per backend rule, confirmed in pbac.types.ts's
