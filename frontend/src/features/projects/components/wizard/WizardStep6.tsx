...
import type { AvailablePointer, ClientReportCadence } from '@/features/projects/project.types'
import { AVAILABLE_POINTER_LABEL, CLIENT_REPORT_CADENCE_LABEL, PAYMENT_TERMS_LABEL, PROJECT_THERAPY_LABEL, PROJECT_TYPE_LABEL } from '@/features/projects/projects.constants'
