import type { Client, Division, ClientMr, MrServiceability, ClientProject, ClientInvoice } from '@/types/client.types'

// Mock/fixture data for the Client Management domain — split out of
// client.types.ts so the type declarations aren't bundled with runtime
// fixture data. TODO: entirely mock/frontend-only — no backend endpoints
// exist for clients yet.
